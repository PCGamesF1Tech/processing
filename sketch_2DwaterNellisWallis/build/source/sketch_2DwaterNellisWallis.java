...
public class sketch_2DwaterNellisWallis extends PApplet {
...
public void mouseReleased()
{
  ...
  public void settings() {  size(600,450);  smooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_2DwaterNellisWallis" };
    if (passedArgs != null) {
